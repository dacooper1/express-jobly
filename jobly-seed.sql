...
INSERT INTO users(username, PASSWORD, first_name, last_name, email, is_admin)
        VALUES ('testuser', '$2b$12$AZH7virni5jlTTiGgEg4zu3lSvAw68qVEfSIOjJ3RqtbJbdW/Oi5q', 'Test', 'User', 'joel@joelburton.com', FALSE),
('testadmin', '$2b$12$AZH7virni5jlTTiGgEg4zu3lSvAw68qVEfSIOjJ3RqtbJbdW/Oi5q', 'Test', 'Admin!', 'joel@joelburton.com', TRUE);

INSERT INTO companies(handle, name, num_employees, description, logo_url)
        VALUES ('bauer-gallagher', 'Bauer-Gallagher', 862, 'Difficult ready trip question produce produce someone.', NULL),
...
('norman-harvey', 'Norman-Harvey', NULL, 'Drop along test material education. Opportunity forget campaign federal certainly total hair.', '/logos/logo4.png'),
...
('arnold-berger-townsend', 'Arnold, Berger and Townsend', 795, 'Kind crime at perhaps beat. Enjoy deal purpose serve begin or thought. Congress everything miss tend.', NULL),
('davis-davis', 'Davis-Davis', 23, 'Career participant difficult. Decide claim particular century society. Question growth two staff.', NULL),
('smith-llc', 'Smith LLC', 908, 'Statement use per mission method. Order truth method.', NULL),
('morgan-sullivan', 'Morgan-Sullivan', 409, 'Own once artist part put authority wait. Focus free even. Why friend civil visit.', NULL),
...
('logan-miller', 'Logan-Miller', 429, 'Pattern hand where never. Social across ability which structure.', NULL),
('hudson-inc', 'Hudson Inc', 627, 'End now meet staff. Long government force why bar. Provide bring hope staff almost many be a.', NULL),
('rivas-llc', 'Rivas LLC', 552, 'Would road lot research wide mouth. Resource along office drug.', NULL),
('garner-michael', 'Garner-Michael', 940, 'Necessary thousand parent since discuss director. Visit machine skill five the.', NULL),
('owen-newton', 'Owen-Newton', 953, 'Red compare try way. Bed standard again number wrong force. Stop exactly agent product economy someone. North describe site manager employee customer.', NULL),
('foster-rice', 'Foster-Rice', 901, 'Either relate himself. Source TV data one general. Actually than seat eight.', NULL),
('moore-plc', 'Moore PLC', 100, 'Magazine thing eight shake window might they organization. Environmental it bag green.', NULL),
('ayala-buchanan', 'Ayala-Buchanan', 309, 'Make radio physical southern. His white on attention kitchen market upon. Represent west open seven. Particularly subject billion much score thank bag somebody.', NULL),
('willis-henson-miller', 'Willis, Henson and Miller', 821, 'About dream practice. Father significant senior health within four.', NULL),
('stone-stewart', 'Stone-Stewart', 459, 'Require successful family but. Traditional article late eight lose common send budget. Better opportunity law country various represent strong probably.', NULL),
...
('mejia-scott-ryan', 'Mejia, Scott and Ryan', NULL, 'General traditional late situation discussion dog. Before best up strategy about direction.', '/logos/logo4.png'),
...
('English as a foreign language teacher', 111000, 0, 'russo-gillespie-conrad'),
...
('Historic buildings inspector/conservation officer', 129000, 0.052, 'watson-davis'),
...
('Historic buildings inspector/conservation officer', 135000, NULL, 'rivas-llc'),
('Sports development officer', 102000, NULL, 'scott-smith'),
('Investment banker, corporate', 131000, NULL, 'ingram-ferguson-rubio'),
('Conservation officer, historic buildings', 168000, NULL, 'robbins-marsh-martin'),
...
('Scientist, research (physical sciences)', 117000, 0.090, 'ayala-buchanan'),
('Historic buildings inspector/conservation officer', 65000, 0.075, 'mejia-scott-ryan'),
